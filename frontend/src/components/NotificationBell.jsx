...
export default function NotificationBell() {
  ...
  return (
    <div ref={ref} style={{ position: "relative" }}>
      <div id="notification-btn-bell" data-testid="notification-btn-bell" data-el-id="EL-018" aria-label="Notifications" onClick={() => setOpen(v => !v)} style={{ cursor: "pointer", position: "relative", display: "inline-flex" }}>
        ...
        <div style={{
          ...
          <div style={{ padding: "12px 16px", borderBottom: `1px solid ${T.navy7}`, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            ...
            <button
              ...
              data-testid="notification-btn-close"
